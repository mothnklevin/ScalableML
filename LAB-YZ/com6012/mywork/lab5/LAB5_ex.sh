...
#SBATCH --mem=14G
#SBATCH --output=/users/acw24yz/com6012/mywork/Output/Lab5.txt  # task output log
...
spark-submit --driver-memory 6g --executor-memory 5g --master local[4] ./LAB5_01.py
spark-submit --driver-memory 6g --executor-memory 5g --master local[4] ./LAB5_02.py
...
echo "LAB5  completed successfully"
