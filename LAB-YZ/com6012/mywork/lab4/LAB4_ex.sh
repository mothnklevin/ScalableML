...
spark-submit --driver-memory 4g --executor-memory 5g --master local[2] ./LAB4_01.py



grep -v "INFO"  /users/acw24yz/com6012/mywork/Output/Lab4.txt > \
                /users/acw24yz/com6012/mywork/Output/Lab4_clean.txt
